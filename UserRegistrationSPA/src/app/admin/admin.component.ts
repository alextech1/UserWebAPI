...
export class AdminComponent implements OnInit {
  ...
  constructor( private activatedRoute: ActivatedRoute,
    ...
    @ViewChild("roleDiv") roleView: ElementRef;
    @ViewChild("orderDiv") orderView: ElementRef;
    @ViewChild("roleMenu") roleMenu: ElementRef;
    @ViewChild("orderMenu") orderMenu: ElementRef;
